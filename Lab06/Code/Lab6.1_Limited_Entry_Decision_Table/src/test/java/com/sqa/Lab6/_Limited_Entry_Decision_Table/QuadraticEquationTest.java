package com.sqa.Lab6._Limited_Entry_Decision_Table;
...
public class QuadraticEquationTest {
    ...
    @DisplayName("Test determineRootNature based on Decision Table Rules")
    void testDetermineRootNature(String rule, String tcId, int a, int b, int c, RootNature expectedNature) {
